...
public class WildnessUtility
{
    ...
    private static float GetOffspringWildnessOffsetContribution(Pawn parent)
    {
        ...
        return parentWildnessOffset + nlearned * Rand.Range(0, offspringWildnessChangePerTrainedSkill);
    }
